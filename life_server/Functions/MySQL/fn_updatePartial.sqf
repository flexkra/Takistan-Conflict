...
switch(_mode) do {
	case 0: {
		...
		switch(_side) do {
			case west: {_query = format["UPDATE players SET cop_cash='%1' WHERE playerid='%2'",_value,_uid];};
			case civilian: {_query = format["UPDATE players SET cash='%1' WHERE playerid='%2'",_value,_uid];};
			case independent: {_query = format["UPDATE players SET med_cash='%1' WHERE playerid='%2'",_value,_uid];};
		};
	};
	...
	case 1: {
		...
		_value = [_value] call DB_fnc_numberSafe;
		switch(_side) do {
			case west: {_query = format["UPDATE players SET cop_bank='%1' WHERE playerid='%2'",_value,_uid];};
			case civilian: {_query = format["UPDATE players SET bankacc='%1' WHERE playerid='%2'",_value,_uid];};
			case independent: {_query = format["UPDATE players SET med_bank='%1' WHERE playerid='%2'",_value,_uid];};
		};
	...
	case 4: {
		...
		_query = format["UPDATE players SET gesamtexp='%1' WHERE playerid='%2'",_value,_uid];
	};
	...
	case 6: {
		...
		switch(_side) do {
			case west: {_query = format["UPDATE players SET cop_cash='%1', cop_bank='%2' WHERE playerid='%3'",_value1,_value2,_uid];};
			case civilian: {_query = format["UPDATE players SET cash='%1', bankacc='%2' WHERE playerid='%3'",_value1,_value2,_uid];};
			case independent: {_query = format["UPDATE players SET med_cash='%1', med_bank='%2' WHERE playerid='%3'",_value1,_value2,_uid];};
		};
	...
	case 8: {
		 ...
		 _query = format["UPDATE containers SET inventory='%1', gear='%2', duration='%3' WHERE pid='%4'",_value1,_value2,_value3,_uid]
	}
};
