...
if(_exp < 0.05) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_0.paa";
};
if(_exp >= 0.05 && _exp < 0.1) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_5.paa";
};
if(_exp >= 0.1 && _exp < 0.15) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_10.paa";
};
if(_exp >= 0.15 && _exp < 0.2) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_15.paa";
};
if(_exp >= 0.2 && _exp < 0.25) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_20.paa";
};
if(_exp >= 0.25 && _exp < 0.3) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_25.paa";
};
if(_exp >= 0.3 && _exp < 0.35) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_30.paa";
};
if(_exp >= 0.35 && _exp < 0.4) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_35.paa";
};
if(_exp >= 0.4 && _exp < 0.45) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_40.paa";
};
if(_exp >= 0.45 && _exp < 0.5) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_45.paa";
};
if(_exp >= 0.50 && _exp < 0.55) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_50.paa";
};
if(_exp >= 0.55 && _exp < 0.6) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_55.paa";
};
if(_exp >= 0.6 && _exp < 0.65) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_60.paa";
};
if(_exp >= 0.65 && _exp < 0.7) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_65.paa";
};
if(_exp >= 0.7 && _exp < 0.75) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_70.paa";
};
if(_exp >= 0.75 && _exp < 0.8) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_75.paa";
};
if(_exp >= 0.8 && _exp < 0.85) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_80.paa";
};

if(_exp >= 0.85 && _exp < 0.9) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_85.paa";
};
if(_exp >= 0.9 && _exp < 0.95) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_90.paa";
};
if(_exp >= 0.95) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_95.paa";
};
if(life_level == 50) then {
	LIFEctrl(IDC_UI_XY_UI_EXP) ctrlSetText "level_100.paa";
};
