...
diag_log format["LICENSE_VALUE(_licenses,civ): %1",LICENSE_VALUE(_licenses,civ)];
...
if(life_cash < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - CASH] call life_fnc_numberText];};
