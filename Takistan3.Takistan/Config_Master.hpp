...
class Life_Settings {
    ...
    noatm_timer = 1; //Time in minutes that players won't be able to deposit his money after selling stolen gold
    ...
    /* Car-shop Settings */
    vehicleShop_rentalOnly[] = { "B_G_Offroad_01_armed_F","B_MRAP_01_hmg_F","O_MRAP_02_F","I_mas_cars_UAZ_M2","B_mas_cars_Hilux_M2","I_mas_cars_LR_soft_M2","I_mas_cars_UAZ_MG","B_mas_cars_Hilux_MG","I_mas_cars_UAZ_SPG9","B_mas_cars_Hilux_SPG9"};
